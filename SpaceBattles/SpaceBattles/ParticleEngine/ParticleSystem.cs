...
namespace SpaceBattles
{
    ...
    public abstract class ParticleSystem : DrawableGameComponent
    {
        ...
        public void AddParticles(Vector2 where)
        {
            ...
            int numParticles = 
                SpriteManager.rnd.Next(minNumParticles, maxNumParticles);
        ...
        protected virtual void InitializeParticle(Particle p, Vector2 where)
        {
            ...
            float velocity = 
                SpriteManager.RandomBetween(minInitialSpeed, maxInitialSpeed);
            float acceleration =
                SpriteManager.RandomBetween(minAcceleration, maxAcceleration);
            float lifetime =
                SpriteManager.RandomBetween(minLifetime, maxLifetime);
            float scale =
                SpriteManager.RandomBetween(minScale, maxScale);
            float rotationSpeed =
                SpriteManager.RandomBetween(minRotationSpeed, maxRotationSpeed);
        ...
        {
            float angle = SpriteManager.RandomBetween(0, MathHelper.TwoPi);
